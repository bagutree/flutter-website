  ...
  Widget build(BuildContext context) {
    return Stack(
      children: <Widget>[
        ...
        //Go to AnimatedBackground widget and comment the child to get bubble only background
  ...
  Widget build(BuildContext context) {
    final tween = MultiTrackTween([
      Track("color1").add(Duration(seconds: 5),
          ColorTween(begin: Color(0xff136a8a), end: Color(0xff185a9d))),
      Track("color2").add(Duration(seconds: 5),
          ColorTween(begin: Color(0xff0b8793), end: Color(0xff001510)))
    ]);
    ...
    return ControlledAnimation(
      ...
      builder: (context, animation) {
        return Container(
          ...
          //Comment this when not using particle_flutter
  ...
  Widget build(BuildContext context) {
    final tween = MultiTrackTween([
      Track("color1").add(Duration(seconds: 3),
          ColorTween(begin: Colors.cyan, end: Colors.lightBlue.shade900)),
    ...
    return ControlledAnimation(
      ...
      duration: tween.duration,
      builder: (context, animation) {
        return particle.Particles(50, animation["color1"]);
      },
    );
  }
}
